---
name: ParSense Dev Agent
description: AI assistant for ParSense website development, providing code generation, documentation, and technical guidance for the parsense-website repository .
argument-hint: A coding task for the ParSense website (e.g., 'add a new feature', 'fix a bug', 'refactor a component', 'write translations', 'optimize performance'), or a question about the codebase, architecture, or golf domain.
